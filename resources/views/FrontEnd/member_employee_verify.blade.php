        ...
        <section class="about-section grey-bg">
          ...
          <div class="col-md-4 col-md-offset-4">
            <div class="border-1px p-25">
              <h4 class="text-theme-colored text-uppercase m-0">VERIFY EMPLOYEE</h4>
              <div class="line-bottom mb-30"></div>


              <form   class="mt-30" method="post" action="{{ route("find.FrontEnd_member_employee_verify") }}">
                @csrf
                <div class="row">
                  <div class="col-sm-12">
