                                    ...
                                    <table id="key-table" class="table table-bordered dt-responsive nowrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#custom-modal"
                                                        ...
                                                        onclick="viewaddress('#{{ $employeedata['id'] }}')" data-animation="fadein"
                                            ...
                                            @endif
                                                ...
                                                <td>
                                                    <span class="badge @if( $employeedata['status'] == 1) badge-success @else bg-danger @endif">@if( $employeedata['status'] == 1) Active @else Block @endif</span>
                                                </td>
                                                <td class="text-center">
                                                    <div class="row">
                                                        <div class="col-sm-12 mb-1">
                                                            <a href="{{ route("admin_employee") }}/id_card/{{ $employeedata['id'] }}" target="_blank"
                                                                class="btn btn-xs btn-success">ID CARD</a>
                                                            <a href="{{ route("admin_employee") }}/welcome/{{ $employeedata['id'] }}" target="_blank"
                                                                class="btn btn-xs btn-success">Welcome</a>
                                                            <a href="{{ route("admin_employee") }}/appointment/{{ $employeedata['id'] }}" target="_blank"
                                                            ...
                                                            <a href="{{ route("admin_employee") }}/edit/{{ $employeedata['id'] }}" target="_blank"
